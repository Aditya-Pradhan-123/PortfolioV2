...
export default function Contact() {
  ...
  const handleSubmit = () => {
    navigate('/contact')
    const privyrData =  JSON.stringify({...form,lead_source: "Portfolio"})

        let config = {
            method: 'post',
            maxBodyLength: Infinity,
            url: 'https://www.privyr.com/api/v1/incoming-leads/0vZfjMQw/kDlccob4#generic-webhook',
            headers: { 
              // 'X-TOKEN': '0vZfjMQw', 
    ...
    >
      ...
      <div ref={contactSection} className="mt-10 flex flex-col gap-20 md:grid md:grid-cols-6 md:px-12">
        <div className="col-span-4">
          ...
          I’m always interested in freelancing opportunities – especially ambitious or unique projects. However, if you have other request or question about me or my projects, don’t hesitate to use the form.
          </p>
          <form
            name="contact"
          ...
          >
            ...
            >
              <span className="relative">
                <span className="absolute bottom-0 h-1 w-0 bg-secondary-700 opacity-90 duration-300 ease-out group-hover:w-full"></span>
        ...
        <div className="col-span-2 grid grid-cols-1 gap-x-4 gap-y-8 text-accent-300 sm:grid-cols-2 sm:gap-y-0 md:grid-cols-1">
          <div className="space-y-3 ">
            ...
            <div className="flex flex-col space-y-3 text-body-2 2xl:text-3xl">
              <a
                href="mailto:pradhanaditya159@gmail.com"
                className="group relative w-fit cursor-pointer"
                target="_blank"
                rel="noreferrer"
              >
                <span>pradhanaditya159@gmail.com</span>
                <span className="absolute bottom-0 left-0 h-[0.12em] w-0 rounded-full bg-secondary-600 duration-300 ease-in-out group-hover:w-full"></span>
              </a>

              <a
                href="tel:+919769740159"
                className="group relative w-fit cursor-pointer"
                target="_blank"
                rel="noreferrer"
              >
                <span>+91-9769740159</span>
                <span className="absolute bottom-0 left-0 h-[0.12em] w-0 rounded-full bg-secondary-600 duration-300 ease-in-out group-hover:w-full"></span>
              </a>
